...
//		],
		...
		analysedVideoUrl: function(video) {
			...
			if(typeof(video) == 'string') {
				...
				if(!this.isUndefined(typeof(video.length))) {
					...
					} else if(!this.isUndefined(typeof(video[0].length))) {
						this.VA = video
					} else {
						for(i = 0; i < video.length; i++) {
		...
		interFace: function() {
			...
			this.getByElement(logoID).innerHTML = this.logo;
			var pd = this.PD;
			this.CB = {
			...
			var cLoadingFillRect = function() {
				...
				cLoading.beginPath();
				cLoading.arc(30, 30, 25, 0.25 * Math.PI, 2 * Math.PI, false);
				cLoading.stroke();
				cLoading.closePath();
				cLoading.beginPath();
				cLoading.strokeStyle = grad2;
				cLoading.arc(30, 30, 25, 0, 0.25 * Math.PI, false);
				cLoading.stroke();
				cLoading.closePath();
				cLoading.restore()
			};
